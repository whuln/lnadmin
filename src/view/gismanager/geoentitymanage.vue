<template>
  <div ref="maindiv" class="main localmain">
    <div class="left item">
      <Tabs class="fullextent" type="card">
        <TabPane name="entity" index="entity" label="实体类">
        ...
        <TabPane name="attribute" index="attribute" label="实体属性表">
    ...
    <div class="right item">
      ...
      <div>
        <Table
          :height="dataTableSize.h"
          :width="dataTableSize.w"
          :columns="columns1"
          :data="data1"
        ></Table>    
        <div>状态栏</div>    
